...
(function (factory) {
    ...
    function buildBootstrapModalHTML() {
        var toolsHtml = '<div class="btn-group">'
            ...
            + '<button id="idAMapPositionPickerReset" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-repeat"></span>&nbsp;resetting</button>'
        ...
        var modalHtml = '<div class="modal fade" id="idAMapPositionPickerModal">'
            ...
            + '<div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title">select地址</h4><small id="idAMapPositionPickerAlert" style="color: red">必须选择一个位置</small></div>'
                    ...
                    AMap.service('AMap.PlaceSearch', function () {
                        ...
                        placeSearch.searchInBounds(searchKeyword, mapObj.getBounds(), function (status, result) {
                            ...
                            if (status == 'complete') {
                                ...
                                $searchPanel.append('<li class="list-group-item disabled"><small>Sorry, no eligible results were found</small></li>');
                            }
                        });
                    });
                }
