<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="user name" prop="username">
          <el-input v-model="ruleForm.username" 
              placeholder="user name" clearable readonly></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.cpicture" label="MessagePicture" prop="cpicture">
          <file-upload
          tip="点击上传MessagePicture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.cpicture" label="MessagePicture" prop="cpicture">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.rpicture" label="replyPicture" prop="rpicture">
          <file-upload
          tip="点击上传replyPicture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.rpicture" label="replyPicture" prop="rpicture">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="Message content" prop="content">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.content" label="Message content" prop="content">
...
export default {
  data() {
	...
	rpicture : false,
      ...
      rules: {
          userid: [
                { required: true, message: 'Message ID cannot be empty', trigger: 'blur' },
          ],
          username: [
          ],
          content: [
                { required: true, message: 'Message Content cannot be empty', trigger: 'blur' },
          ],
          cpicture: [
          ],
          reply: [
