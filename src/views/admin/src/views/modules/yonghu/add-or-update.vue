<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="user name" prop="yonghuming">
          <el-input v-model="ruleForm.yonghuming" 
              placeholder="user name" clearable  :readonly="ro.yonghuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="user name" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="sex" prop="xingbie">
          <el-select :disabled="ro.xingbie" v-model="ruleForm.xingbie" placeholder="selectsex">
            <el-option
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="head sculpture" prop="touxiang">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="head sculpture" prop="touxiang">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="phone num" prop="shouji">
          <el-input v-model="ruleForm.shouji" 
              placeholder="phone num" clearable  :readonly="ro.shouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="phone num" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
