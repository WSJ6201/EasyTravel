<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Specialty name" prop="techanmingcheng">
          <el-input v-model="ruleForm.techanmingcheng" 
              placeholder="Specialty name" clearable  :readonly="ro.techanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Specialty name" prop="techanmingcheng">
              <el-input v-model="ruleForm.techanmingcheng" 
                placeholder="Specialty name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Specialty type" prop="techanleixing">
          <el-select :disabled="ro.techanleixing" v-model="ruleForm.techanleixing" placeholder="selectSpecialty type">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Specialty type" prop="techanleixing">
	      <el-input v-model="ruleForm.techanleixing"
                placeholder="Specialty type" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="City" prop="suozaichengshi">
          <el-input v-model="ruleForm.suozaichengshi" 
              placeholder="City" clearable  :readonly="ro.suozaichengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="City" prop="suozaichengshi">
              <el-input v-model="ruleForm.suozaichengshi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Detailed address" prop="xiangxidizhi">
          <el-input v-model="ruleForm.xiangxidizhi" 
              placeholder="Detailed address" clearable  :readonly="ro.xiangxidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Detailed address" prop="xiangxidizhi">
              <el-input v-model="ruleForm.xiangxidizhi" 
                placeholder="Detailed address" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="Specialty introduction" prop="techanjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.techanjieshao" label="Specialty introduction" prop="techanjieshao">
...
export default {
  data() {
	...
	techanjieshao : false,
      ...
      rules: {
          techanmingcheng: [
                { required: true, message: 'Specialty name cannot be empty', trigger: 'blur' },
          ],
          techanleixing: [
                { required: true, message: 'Special type cannot be empty', trigger: 'blur' },
          ],
          tupian: [
          ],
          suozaichengshi: [
  ...
  methods: {
	...
	this.ruleForm.techanjieshao = this.ruleForm.techanjieshao.replace(reg,'../../../easytravel/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
