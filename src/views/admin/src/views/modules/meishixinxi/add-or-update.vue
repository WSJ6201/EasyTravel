<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Food name" prop="meishimingcheng">
          <el-input v-model="ruleForm.meishimingcheng" 
              placeholder="Food name" clearable  :readonly="ro.meishimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Food name" prop="meishimingcheng">
              <el-input v-model="ruleForm.meishimingcheng" 
                placeholder="Food name" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="Food type" prop="meishileixing">
          <el-select :disabled="ro.meishileixing" v-model="ruleForm.meishileixing" placeholder="selectFood type">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="Food type" prop="meishileixing">
	      <el-input v-model="ruleForm.meishileixing"
                placeholder="Food type" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="Food info" prop="meishixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.meishixiangqing" label="Food info" prop="meishixiangqing">
...
export default {
  data() {
	...
	meishixiangqing : false,
      ...
      rules: {
          meishimingcheng: [
                { required: true, message: 'Food name cannot be empty', trigger: 'blur' },
          ],
          meishileixing: [
                { required: true, message: 'Food type cannot be empty', trigger: 'blur' },
          ],
          tupian: [
          ],
          suozaichengshi: [
  ...
  methods: {
	...
	this.ruleForm.meishixiangqing = this.ruleForm.meishixiangqing.replace(reg,'../../../easytravel/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
