<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="collectname" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="collectname" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="collectname" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="collectname" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="collectPicture" prop="picture">
          <file-upload
          tip="Click to upload the collection picture"
          action="file/upload"
          :limit="3"
          :multiple="true"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="collectPicture" prop="picture">
  ...
  data() {
	...
	inteltype : false,
      ...
      rules: {
          ...
          name: [
                { required: true, message: 'Collection name cannot be empty', trigger: 'blur' },
          ],
          picture: [
                { required: true, message: 'Collect Picture cannot be empty', trigger: 'blur' },
          ],
          type: [
          ],
          inteltype: [
